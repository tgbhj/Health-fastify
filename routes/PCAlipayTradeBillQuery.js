...
module.exports = async (fastify, options, next) => {
    fastify.post('/alipay/billQuery', async (req, reply) => {
        try {
            ...
            // console.log('[bill_type, bill_date]', bill_type, bill_date, typeof bill_type, typeof bill_date)
...
//     try {
//         let {billType, billDate} = ctx.request.body;
//         // console.log('[bill_type, bill_date]', bill_type, bill_date, typeof bill_type, typeof bill_date)
//
//         let errArray = [];
//         !alipayFactory.isType(billType) && errArray.push('billType is required');
